  ...
  return (
    <div className="min-h-screen flex flex-col transition-colors duration-300">
      ...
      >
        ...
        {/* Main content area */}
        <main className={clsx('flex-1 overflow-y-auto overflow-x-hidden min-h-0 py-3 sm:py-4 pb-4 transition-all duration-300', aiTransitionPhase !== 'idle' && 'opacity-0 blur-md')}>
