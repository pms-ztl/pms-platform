...
export function ExportCard({ title, description, icon: Icon, iconColor = 'text-blue-600 dark:text-blue-400', iconBg = 'bg-blue-100 dark:bg-blue-900/30', onExport, isExporting }: ExportCardProps) {
  return (
    <div className="bg-white/90 dark:bg-secondary-800/70 backdrop-blur-xl rounded-xl shadow-sm border border-secondary-200/60 dark:border-white/[0.06] p-5 flex flex-col">
      ...
      <div className="mt-auto">
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-secondary-300 dark:border-secondary-600 text-secondary-700 dark:text-secondary-300 hover:bg-primary-50/30 dark:hover:bg-white/[0.03] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          {isExporting ? (
            <>
