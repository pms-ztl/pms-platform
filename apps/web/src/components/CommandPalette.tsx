    ...
    <Transition appear show={open} as={Fragment}>
      <Dialog as="div" className="relative z-[60]" onClose={handleClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto p-4 sm:p-6 md:p-20">
          ...
          >
            <Dialog.Panel className="mx-auto max-w-lg overflow-hidden rounded-2xl bg-white/90 dark:bg-secondary-800/70 backdrop-blur-xl shadow-2xl ring-1 ring-secondary-200 dark:ring-secondary-700">
