...
const AGENT_CLUSTERS: ClusterDef[] = [
  {
    ...
    agents: [
      ...
      { type: 'strategic_alignment', name: 'Strategy', description: 'OKR alignment & 1:1 snapshots', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'talent_marketplace', name: 'Talent Market', description: 'Mobility, skill matching & goals', gradientFrom: 'from-sky-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-sky-500/30' },
      ...
      { type: 'report', name: 'Report', description: 'Generate & export reports', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'notification', name: 'Notification', description: 'Smart alerts & digests', gradientFrom: 'from-cyan-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-cyan-500/30' },
      ...
      { type: 'one_on_one_advisor', name: '1:1 Advisor', description: '1:1 meeting intelligence & agenda builder', gradientFrom: 'from-sky-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-sky-500/30' },
    ],
  },
  {
    id: 'bio_performance',
    ...
    agents: [
      ...
      { type: 'ergonomics', name: 'Ergonomics', description: 'Posture & workspace setup', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      { type: 'sleep_optimizer', name: 'Sleep Optimizer', description: 'Sleep quality & schedule', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      { type: 'hydration_nutrition', name: 'Hydration', description: 'Water, nutrition & energy', gradientFrom: 'from-cyan-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-cyan-500/30' },
  ...
  },
  {
    ...
    agents: [
      ...
      { type: 'micro_learning', name: 'Micro Learn', description: 'Bite-sized daily lessons', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-500/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'skill_gap_forecaster', name: 'Skill Forecast', description: 'Future skill demand prediction', gradientFrom: 'from-purple-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-purple-500/30' },
      ...
      { type: 'linguistic_refiner', name: 'Linguistic', description: 'Writing & communication', gradientFrom: 'from-sky-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-sky-500/30' },
      ...
      { type: 'logic_validator', name: 'Logic Check', description: 'Argument & reasoning validation', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
  ...
  },
  {
    ...
    agents: [
      { type: 'task_bidder', name: 'Task Bidder', description: 'Optimal task allocation', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      { type: 'gig_sourcer', name: 'Gig Sourcer', description: 'Internal gig matching', gradientFrom: 'from-purple-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-purple-500/30' },
      ...
      { type: 'equity_realizer', name: 'Equity', description: 'Stock options & vesting', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'relocation_bot', name: 'Relocation', description: 'City comparison & COL', gradientFrom: 'from-sky-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-sky-500/30' },
  ...
  },
  {
    ...
    agents: [
      ...
      { type: 'conflict_mediator', name: 'Mediator', description: 'Interpersonal conflict resolution', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'empathy_coach', name: 'Empathy Coach', description: 'Emotional intelligence training', gradientFrom: 'from-teal-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-teal-500/30' },
      ...
      { type: 'mood_radiator', name: 'Mood Radiator', description: 'Team sentiment dashboard', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-primary-500/30' },
    ],
  },
  {
    id: 'governance_logic',
    ...
    agents: [
      ...
      { type: 'labor_compliance', name: 'Labor Law', description: 'Working hours & regulations', gradientFrom: 'from-primary-500/20', gradientTo: 'to-primary-500/20', glowColor: 'shadow-primary-500/30' },
      ...
      { type: 'data_privacy', name: 'Data Privacy', description: 'GDPR & data protection', gradientFrom: 'from-purple-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-purple-500/30' },
      ...
      { type: 'leave_optimizer', name: 'Leave Optimizer', description: 'PTO & vacation planning', gradientFrom: 'from-sky-500/20', gradientTo: 'to-primary-400/20', glowColor: 'shadow-sky-500/30' },
