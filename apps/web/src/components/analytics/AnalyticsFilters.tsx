  ...
  return (
    <div className="flex flex-wrap items-center gap-3 px-1">
      ...
      <select
        ...
        className="text-xs rounded-lg border border-secondary-200 dark:border-secondary-700/50 bg-white/90 dark:bg-secondary-900/60 backdrop-blur-sm text-secondary-700 dark:text-secondary-300 px-3 py-1.5 focus:ring-2 focus:ring-primary-500/50 focus:border-primary-400 transition-all duration-300"
      >
