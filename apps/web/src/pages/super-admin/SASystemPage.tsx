        ...
        <div className="p-6">
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="pt-4">
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 text-white rounded-lg px-4 py-2.5 text-sm font-medium transition-colors"
                >
          ...
          {activeTab === 'maintenance' && (
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="flex items-center justify-between p-4 rounded-lg border border-secondary-200 dark:border-secondary-700 bg-secondary-50 dark:bg-secondary-900/30">
              ...
              <div className="border-t border-secondary-200 dark:border-secondary-700 pt-6 mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg border border-secondary-300 dark:border-secondary-600 text-secondary-700 dark:text-secondary-300 hover:bg-secondary-50 dark:hover:bg-secondary-700 transition-colors disabled:opacity-50"
                  >
