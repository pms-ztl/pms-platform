            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full max-w-xs rounded-lg border border-secondary-200 dark:border-secondary-700/50 bg-white dark:bg-secondary-800 px-3 py-2 text-sm text-secondary-900 dark:text-white focus:ring-2 focus:ring-primary-500/50 focus:border-primary-400 backdrop-blur-sm transition-all duration-300"
                >
