...
router.get(
  ...
  (req, res, next) => auditController.list(req as any, res, next)
);
...
router.get(
  '/stats',
  authorize({ resource: 'audit', action: 'read', scope: 'all' }),
  (req, res, next) => auditController.getStats(req as any, res, next)
);
...
router.get(
  ...
  authorize({ resource: 'audit', action: 'read', scope: 'all' }),
  (req, res, next) => auditController.getEntityHistory(req as any, res, next)
);
...
router.get(
  ...
  (req, res, next) => auditController.getUserActivity(req as any, res, next)
);
...
router.get(
  '/:id',
  authorize({ resource: 'audit', action: 'read', scope: 'all' }),
  (req, res, next) => auditController.getById(req as any, res, next)
);
